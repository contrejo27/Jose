...
namespace BrandXR
{
    ...
    public class XRReticleRing: MonoBehaviour, XRGazePointer
    {
        ...
        void OnEnable()
        {
            XRGazeInputModule.gazePointer = this;
        }

        void OnDisable()
        {
            if( (Object)XRGazeInputModule.gazePointer == this )
            {
                XRGazeInputModule.gazePointer = null;
            }
        }
